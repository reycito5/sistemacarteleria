...
const SAMPLE_INPUTS: ViewContentInput[] = [
  ...
  },
  {
    ...
    sectionTitle: "Próximos inicios de gestión",
    programs: [
      {
        name: "Maestría en Educación Superior",
        type: "Maestría",
      ...
      {
        name: "Especialidad en Docencia Universitaria",
        type: "Especialidad",
        modality: "Virtual",
        duration: "8 meses",
        credits: "32 créditos",
        dateShort: "31 AGO 2026",
        status: "open",
      },
      {
        name: "Diplomado en Tributación y Legislación Fiscal",
        type: "Diplomado",
        modality: "Virtual",
        duration: "4 meses",
        credits: "20 créditos",
  ...
  },
  {
    ...
    startAt: "22:00",
    duration: "45 min",
    scope: "Pantalla: Hall Principal",
    supportContact: "soporte@uabjb.edu.bo",
  },
  {
    kind: "emergencia",
